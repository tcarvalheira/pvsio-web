...
//            var from = event.from;
        ...
        radical.spo2_display = new Wave('spo2_display',
                                                    { top: 56, left: 150, width: 120 },
                                                    { waveType: 'pleth', 
                                                        parent: 'prototype',
                                                        heartRate: 60,
                                                        waveColor: '#FFFFFF',
        ...
        radical.spo2_d = new BasicDisplayEVO(
            'spo2_disp',
            {top: 50, left: 280, width: 50, height: 34},
            {
                parent: 'prototype',
                fontColor: '#FFFFFF',
                fontSize: 12,
        ...
        /* radical.rra_display = new PatientMonitorDisplay("rra_display",
            ...
            radical.rra_display = new Wave('rra_display',
                    { top: 102, left: 150, height:34, width: 120 },
                    {   waveType: 'ecg', 
                        parent: 'prototype',
                        heartRate: 80,
                        waveColor: '#00FF00',
            ...
            radical.rra_d = new BasicDisplayEVO(
                        'rra_d',
                        {top: 98, left: 280, width: 50, height: 34},
                        {
                            parent: 'prototype',
                            fontColor: '#FF8C94',
                            fontSize: 12,
        ...
        function render_spo2(res) {
            if (res.isOn === "TRUE") {
                ...
                radical.spo2_d.render('60')
                radical.spo2_display.setParameters({heartRate: 60})
        ...
        function render_rra(res) {
            if (res.isOn === "TRUE") {
                ...
                radical.rra_d.render('80')
                radical.rra_display.setParameters({heartRate: 120, waveType : 'ecg'})
